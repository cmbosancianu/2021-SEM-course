...
\node[draw, circle, inner sep=1] (l13) at (6.75,1.25) {\tiny{$D_1$}};
\node[draw, circle, inner sep=1] (l14) at (10.75,1.25) {\tiny{$D_2$}};
% Arrows
...
\draw [->, thin, >=latex] (l5)--(l9);
\draw [->, thin, >=latex] (l13)--(l5.south east) node[midway,right] {\tiny 1};
\draw [->, thin, >=latex] (l14)--(l9.south east) node[midway,right] {\tiny 1};
% Residuals:
...
\draw[<->, very thin, >=latex] (l1) to [out=250,in=290,looseness=9] (l1);
...
\draw[<->, very thin, >=latex] (l13) to [out=250,in=290,looseness=9] (l13);
\draw[<->, very thin, >=latex] (l14) to [out=250,in=290,looseness=9] (l14);
\end{tikzpicture}
