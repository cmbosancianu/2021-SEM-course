...
\node[draw] (y1) at (5,3) {\tiny{PRT}};
\node[draw] (x1) at (1,3) {\tiny{EDC}};
\node[draw] (m1) at (3,4) {\tiny{EFF}};
\node[draw, circle, inner sep=2] (d1) at (6,4) {\tiny{$D_1$}};
\node[draw, circle, inner sep=2] (d2) at (4,5) {\tiny{$D_2$}};
\draw [->, very thin, >=latex] (x1)--(y1.west) node [midway, above] {\tiny{$\beta_{xy}$}};
\draw [->, very thin, >=latex] (x1)--(m1.west) node [midway, above] {\tiny{$\beta_{xm}$}};
\draw [->, very thin, >=latex] (m1.east)--(y1.west) node [midway, above] {\tiny{$\beta_{my}$}};
