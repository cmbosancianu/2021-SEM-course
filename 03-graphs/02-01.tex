...
\draw [->, thin, >=latex] (x1.east)--(m1.west);
\draw [->, thin, >=latex] (x2.east)--(m2.west);
\draw [->, thin, >=latex] (m1.east)--(y1.west);
\draw [->, thin, >=latex] (m2.east)--(y1.west);
...
% Residuals:
\draw[<->, very thin, >=latex] (x1) to [out=250,in=290,looseness=9] (x1);
\draw[<->, very thin, >=latex] (x2) to [out=70,in=110,looseness=9] (x2);
\draw[<->, very thin, >=latex] (d2) to [out=70,in=110,looseness=9] (d2);
\draw[<->, very thin, >=latex] (d1) to [out=250,in=290,looseness=9] (d1);
\draw[<->, very thin, >=latex] (d3) to [out=70,in=110,looseness=9] (d3);
\draw[<->, very thin, >=latex] (x1) to [out=180,in=180,looseness=2] (x2);
\end{tikzpicture}
